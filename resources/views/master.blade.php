...
<head>
	<meta charshet="UTF-8">		
	<title>@yield('page_tittle','Halaman Awal') | Laboratorium Framework</title>
...
<body>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown active">
						...
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							...
							<li class="divider"></li>
							<li><a href="{{url('dosen_matakuliah')}}">Data Dosen Matakuliah</a></li>
						</ul>
					</li>
					<li class="dropdown active">
	...
	<nav class="navbar navbar-default navbar-fixed-bottom">
		<footer class="container">
			created by <a href="https://www.facebook.com/edwin.ginanjar.9"><span><i class="fa fa-facebook" style="color:#1daf12"></i>Edwin Ginanjar</span></a>
		</footer>
	</nav>
